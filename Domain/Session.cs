...
{
    /// <summary>
    /// Represents a Session entity with a unique ID, start time, end time, location, associated flows, and respondents.
    /// </summary>
    public class Session
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Session"/> class with the specified start time, end time, location, flows, and respondents.
        /// </summary>
        ...
        public Session(DateTime startTime, DateTime endTime, string location, IEnumerable<Flow> flows, IEnumerable<Respondent> respondents)
        {
            StartTime = startTime;
            EndTime = endTime;
            Location = location;
